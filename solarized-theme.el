...
(solarized-with-values
  (eval
   `(custom-theme-set-faces
     ...
     '(gnus-summary-high-ancient ((t (:foreground ,solarized-comment :weight bold))))
     '(gnus-summary-high-read ((t (:foreground ,solarized-fg :weight bold))))
     '(gnus-summary-high-ticked ((t (:foreground ,orange-hc :weight bold))))
     '(gnus-summary-high-unread ((t (:foreground ,solarized-emph :weight bold))))
     '(gnus-summary-low-ancient ((t (:foreground ,solarized-comment :slant italic))))
     '(gnus-summary-low-read ((t (:foreground ,solarized-fg :slant italic))))
     '(gnus-summary-low-ticked ((t (:foreground ,orange-lc :slant italic))))
     '(gnus-summary-low-unread ((t (:foreground ,solarized-emph :slant italic))))
     '(gnus-summary-normal-ancient ((t (:foreground ,solarized-comment))))
     '(gnus-summary-normal-read ((t (:foreground ,solarized-fg))))
     '(gnus-summary-normal-ticked ((t (:foreground ,orange))))
     '(gnus-summary-normal-unread ((t (:foreground ,solarized-emph))))
     ...
     '(magit-tag ((t (:inherit magit-log-sha1))))
     '(magit-item-highlight
       ((t (:background ,solarized-hl :weight unspecified))))
     '(magit-log-author ((t (:foreground ,cyan))))
     '(magit-log-graph ((t (:foreground ,solarized-comment))))
     '(magit-log-head-label-bisect-good
       ((t (:foreground ,green-lc :background ,green-hc :box 1))))
     '(magit-log-head-label-bisect-skip
       ((t (:foreground ,solarized-comment :weight bold :box 1))))
     '(magit-log-head-label-bisect-bad
       ((t (:foreground ,red-lc :background ,red-hc :box 1))))
     '(magit-log-head-label-default ((t (:background ,solarized-hl :box 1))))
     '(magit-log-head-label-local
       ((t (:foreground ,blue-hc :background ,blue-lc :box 1))))
     '(magit-log-head-label-patches
       ((t (:foreground ,red-hc :background ,red-lc :box 1))))
     '(magit-log-head-label-remote
       ((t (:foreground ,green-hc :background ,green-lc :box 1))))
     '(magit-log-head-label-tags
       ((t (:foreground ,yellow-hc :background ,yellow-lc :box 1))))
