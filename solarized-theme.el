...
(solarized-with-values
  (eval
   `(custom-theme-set-faces
     ...
     '(helm-emms-playlist ((t (:foreground ,orange))))
     ...
     '(helm-gentoo-match ((t (:foreground ,red))))
     ...
     '(wl-highlight-summary-prefetch-face ((t (:foreground ,solarized-fg :slant italic))))
     '(wl-highlight-summary-refiled-face ((t (:foreground ,solarized-fg))))
     '(wl-highlight-summary-resend-face ((t (:foreground ,orange))))
