...
(solarized-with-values
  (eval
   `(custom-theme-set-faces
     ...
     '(erc-default-face ((t (:foreground ,base0))))
     '(erc-highlight-face ((t (:inherit erc-default-face :background ,base02))))
     ...
     '(erc-prompt-face ((t (:foreground ,orange :background ,base03 :weight bold))))
