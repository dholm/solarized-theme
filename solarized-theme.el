...
(solarized-with-values
  (eval
   `(custom-theme-set-faces
     ...
     '(gnus-summary-high-unread ((t (:foreground ,base0 :weight bold))))
     '(gnus-summary-low-ancient ((t (:foreground ,blue))))
     '(gnus-summary-low-read ((t (:foreground ,green))))
     '(gnus-summary-low-ticked ((t (:foreground ,orange))))
     '(gnus-summary-low-unread ((t (:foreground ,base0))))
     ...
     '(gnus-summary-normal-unread ((t (:foreground ,base0))))
