...
(solarized-with-values
  (eval
   `(custom-theme-set-faces
     ...
     '(company-preview-common ((t (:foreground ,base1))))
     ...
     '(company-tooltip-annotation-selection ((t (:foreground ,cyan :weight bold))))
     '(company-tooltip-common ((t (:foreground ,base0))))
     '(company-tooltip-common-selection ((t (:inherit company-tooltip-common :weight bold))))
     '(company-tooltip-mouse ((t (:background ,cyan-hc :foreground ,cyan-lc))))
     '(company-tooltip-search ((t (:foreground ,orange))))
     '(company-tooltip-search-selection ((t (:inherit company-tooltip-search :weight bold))))
     '(company-tooltip-selection ((t (:inherit company-tooltip-common :weight bold))))
     ...
     ;; js3-mode
     '(js3-error ((t (:foreground ,red))))
     '(js3-external-variable ((t (:foreground ,orange))))
     '(js3-function-param ((t (:foreground ,green))))
     '(js3-instance-member ((t (:foreground ,magenta))))
     '(js3-jsdoc-html-tag-delimiter ((t (:foreground ,cyan))))
     '(js3-jsdoc-html-tag-name ((t (:foreground ,orange))))
     '(js3-jsdoc-tag ((t (:foreground ,cyan))))
     '(js3-jsdoc-type ((t (:foreground ,blue))))
     '(js3-jsdoc-value ((t (:foreground ,violet))))
     '(js3-magic-paren ((t (:underline t))))
     '(js3-private-function-call ((t (:foreground ,yellow))))
     '(js3-private-member ((t (:foreground ,blue))))
     '(js3-warning ((t (:underline ,orange))))
     ...
     '(markdown-code-face ((t (:inherit fixed-pitch :foreground ,base01
                                        :background unspecified))))
     '(markdown-comment-face ((t (:foreground ,base01 :strike-through t))))
     '(markdown-footnote-face ((t (:inherit default))))
     '(markdown-header-delimiter-face ((t (:foreground ,base01))))
     ...
     '(markdown-header-rule-face ((t (:foreground ,base01))))
     '(markdown-inline-code-face ((t (:foreground ,base01))))
     ...
     '(markdown-link-face ((t (:inherit default :foreground ,yellow))))
     ...
     '(markdown-pre-face ((t (:foreground ,base01))))
     '(markdown-reference-face ((t (:inherit default :foreground ,base01))))
     '(markdown-url-face ((t (:foreground ,base01))))
